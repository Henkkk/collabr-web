                ...
                <div className="flex-shrink-0 flex items-center">
                    ...
                    {primaryWallet && (
                        <>
                            ...
                            <Link href="/profile">
                                <button className="ml-4 p-2 rounded-full text-gray-600 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-200 focus:ring-black">
